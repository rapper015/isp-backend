"""Best-effort Redis/Valkey helpers for the workforce service.

Redis is used ONLY for safe caching, short-lived advisory locks, rate limiting
and sync/queue acceleration. It is never authoritative for work orders,
assignments, appointments, check-ins, proof, inventory movement, SLA, QA or
audit history — the database is."""
