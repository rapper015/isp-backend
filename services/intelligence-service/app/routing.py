"""Tenant-scoping enforcement for the Intelligence Service.

Tenant-owned models require a validated TenantContext. Access without context
fails closed. Platform aggregates (model registry, global models, cross-tenant
views) require explicit PLATFORM_AGGREGATE scope."""
